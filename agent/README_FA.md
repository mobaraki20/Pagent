...
- سطح میانی Renderer پیش از ارسال به Driver به 24-bit BGR بدون Alpha تبدیل می‌شود.
...
## خروجی حرارتی بومی در 6.1.3

- خروجی نهایی به DIB تک‌رنگ ۱‌بیتی تبدیل و بدون Stretch با `SetDIBitsToDevice` به Queue فرستاده می‌شود.
- اندازهٔ متن ردیف‌های سند مشتری مستقیماً از `table_font_size` گرفته می‌شود و دیگر به اندازهٔ کوچک متن پایه سقوط نمی‌کند.
