...
if(-not (Test-Path (Join-Path $installRoot 'Service\Sokna.PrintAgent.Service.exe'))){throw 'Installed Service executable missing.'}
if(-not (Test-Path (Join-Path $installRoot 'Worker\Sokna.PrintAgent.Worker.exe'))){throw 'Installed Worker executable missing.'}
if(-not (Test-Path (Join-Path $installRoot 'Control\Sokna.PrintAgent.Control.exe'))){throw 'Installed Control executable missing.'}
